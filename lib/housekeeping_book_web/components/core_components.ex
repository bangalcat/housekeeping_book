defmodule HousekeepingBookWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg-white dark:bg-gray-700 p-7 md:p-14 shadow-lg ring-1 transition"
            >
              <div class="absolute top-6 right-5">
                <button
                  phx-click={JS.exec("data-cancel", to: "##{@id}")}
                  type="button"
                  class="-m-3 flex-none p-3 opacity-20 hover:opacity-40 dark:text-zinc-50"
            ...
            >
              <div class="block py-4 pr-6 group-hover:dark:text-zinc-800">
                ...
                <span class={[
                  "relative",
                  i == 0 &&
                    "font-semibold text-zinc-900 dark:text-white group-hover:dark:text-zinc-800"
                ]}>

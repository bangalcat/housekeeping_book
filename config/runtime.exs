...
#
#     PHX_SERVER=true bin/housekeeping_book start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :housekeeping_book, HousekeepingBookWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :housekeeping_book, :cert_path, "/home/donghyun/site_encrypt_db"
